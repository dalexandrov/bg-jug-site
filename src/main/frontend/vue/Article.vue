        ...
        <div class="col-md-8">
          ...
          <article class="single-post-content">
            ...
            <div class="blog-item-wrap">
              ...
              <h2 class="blog-title">{{ article.title }}</h2><!-- Entry Meta Start-->
            ...
            <div class="feature-inner single-space">
              <a href="#"><img alt="" src="img/blog/blog-02.jpg"></a>
            </div><!-- Feature inner End -->
            <div class="links">
              <a class="heart" href="#"><i class="ico-heart"></i>
                (143)</a> <a class="twitter" href="#"><i class="ico-twitter-with-circle"></i> Tweet</a> <a class="facebook" href="#"><i class=
