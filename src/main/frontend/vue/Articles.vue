      ...
      <div class="col-md-8">
        ...
        <article v-for="article in articles">
          ...
          <div class="blog-item-wrap">
            ...
            <h2 class="blog-title"><router-link :to="{ name:'article', params:{ id:article.id } }">{{ article.title }}</router-link></h2><!-- Entry Meta Start-->
            <div class="entry-meta">
              <span class="meta-part"><i class="ico-user"></i> <a href="#">{{ article.author.firstName}} {{article.author.lastName }}</a></span>
            ...
            <div class="entry-more">
              <div class="pull-left">
                <router-link class="btn btn-common" to="/article">Read More <i class="ico-arrow-right"></i></router-link>
              </div>
        ...
        <div class="sidebar">
          <div class="entry-widget">
            <div class="widget-profile">
              <div class="image"><img alt="" src=
                "img/blog/cover.jpg"></div>
              <div class="portfolio"><img alt="" src=
                     ...
                     data-placement="top" data-toggle=
                       ...
                       "Twitter"><i class=
                                      "fa fa-twitter"></i></a> <a class=
                                                                    "facebook social-link" data-placement=
                                                                    "top" data-toggle="tooltip" href="#"
                                                                  title="Facebook"><i class=
                                                                                        "fa fa-facebook"></i></a> <a
                  class=
                  ...
                  data-placement="top" data-toggle=
                    ...
                    "Google+"><i class=
                                   "fa fa-google-plus"></i></a> <a class=
                                                                     "linkedin social-link" data-placement=
                                                                     "top" data-toggle="tooltip" href="#"
                                                                   title="LinkedIn"><i class=
                                                                                         "fa fa-linkedin"></i></a> <a
                  class=
                    "dribbble social-link" data-placement=
                    "top" data-toggle="tooltip" href="#"
                  title="Dribbble"><i class=
                                        "fa fa-dribbble"></i></a> <a class=
                                                                       "pinterest social-link" data-placement=
                                                                       "top" data-toggle="tooltip" href="#"
                                                                     title="Pinterest"><i class=
                                                                                            "fa fa-pinterest"></i></a>
                </div>
              </div>
            </div>
            ...
            <div class="accordion">
              <div class="panel-group" id="accordion">
                ...
                <div class="panel panel-default">
                  <!-- Toggle Headin -->
                  <h4 class="panel-title"><a data-parent=
                                               "#accordion" data-toggle="collapse"
                                             href="#collapse-1"><i class=
                                                                     "ico-keyboard_arrow_right"></i> Classic
                    Interface</a></h4>
                  <!-- Toggle Content -->
                ...
                <div class="panel panel-default">
                  ...
                  <h4 class="panel-title"><a data-parent=
                                               "#accordion" data-toggle="collapse"
                                             href="#collapse-2"><i class=
                                                                     "ico-keyboard_arrow_right"></i>
                    Modern</a></h4><!-- Toggle Content -->
                  <div class="panel-collapse collapse"
                       id="collapse-2">
                    <div class="panel-body">
                      <ul class="cat-menu-list">
                ...
                <div class="panel panel-default">
                  ...
                  <h4 class="panel-title"><a data-parent=
                                               "#accordion" data-toggle="collapse"
                                             href="#collapse-6"><i class=
                                                                     "ico-keyboard_arrow_right"></i> Video
                    cover</a></h4><!-- Toggle Content -->
                  <div class="panel-collapse collapse"
                       id="collapse-6">
                    <div class="panel-body">
                      <ul class="cat-menu-list">
          ...
          <div class="entry-widget">
            ...
            <div class="flickr">
              ...
              <a class="btn btn-common more" href=
